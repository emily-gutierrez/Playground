...
let checksocialmedia = 20

let maketeaorcoffee = 10
...
let totaltime = brushTeeth + dohair + eatbreakfast + checksocialmedia + washface + maketeaorcoffee
...
let thingsimustdo = brushTeeth + dohair + washface

let thingsiliketodo = eatbreakfast + checksocialmedia + maketeaorcoffee
