 ...
 */
let badstrings = "i learned what back strings look like"
let quotations = "i learned we could use quotations to adress what other people say"
let backslash = "you can use the backlash to continure a string"
