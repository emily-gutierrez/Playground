...
let schoolName = "Chicken Little Elementery"
let refrain = "hmm hmm HMMM hm-hmm \("Chicken Little Elementery") hmm hmm HMMMMM"

let song = "\("hmm hmm HMM hm-hmm")\n\("hmm hmm HMM hm-hmm")\nYes, \("hmm hmm HMM hm-hmm")"
